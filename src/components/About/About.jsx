    ...
    return (
        <div className={page == "About" ? "sectionAbout" : "oculto"}>
            ...
            <div className="texto">
                ...
                <p>Los hilos verticales están teñidos de rojo más oscuro cuanto más feliz sea tu recuerdo.</p>
                <p>Mientras tanto, los hilos horizontales adquieren un azul más intenso cuanto más reciente sea el recuerdo.</p>
            </div>
