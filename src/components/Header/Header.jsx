    ...
    return (
        <header className="header">
            ...
            <div className="enlaces">
                ...
                {page !== "Preguntas" ? <a href="#inicioseccion"  className={page == "About"? "enlace enlaceseleccionado" : "enlace"} onClick={() => page !== "Preguntas" ? setPage("About"):null}>Cómo funciona</a>: null}
